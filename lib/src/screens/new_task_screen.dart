...
class _NewTaskScreenState extends State<NewTaskScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: newTaskScreenAppBar(context, _formKey),
...
class _NewTaskScreenBodyState extends State<NewTaskScreenBody> {
  ...
  //  ekrana, treba promeniti inicijalizaciju tako da se ilidaje vrednost iz
  ...
  Widget build(BuildContext context) {
    /*print('\n');
    kopijaDefaultRemindersForTimeSensitiveTasks.forEach((e) => print(e));
    kopijaDefaultRemindersForTimeSensitiveTasks.sort();
    print('\n');
    kopijaDefaultRemindersForTimeSensitiveTasks.forEach((e) => print(e));
    print('\n');
    print(timeSensitiveTaskReminders);
    print('\n');
    print(allDayTaskReminders);
    print('\n');
    kopijaDefaultRemindersForAllDayTasks.forEach((e) => print(e));
    kopijaDefaultRemindersForAllDayTasks.sort();
    print('\n');
    kopijaDefaultRemindersForAllDayTasks.forEach((e) => print(e));*/
                                ...
                                if (pickedTime.hour > currentTime.hour ||
                                  ...
                                  if (newStartDateTime.compareTo(endDate) < 0) {
                                    ...
                                    setState(() {
                                      ...
                                      currentStartTime = pickedTime;
                                      currentEndTime = TimeOfDay.fromDateTime(
                                          newEndDateTime);
                                    });
                                  }
                                } else {
                                  ...
                                  Scaffold.of(context).showSnackBar(SnackBar(
                                    content: Text(
                                        'Can not schedule tasks in past...'),
                                  ));
                                }
                              }
                            }
